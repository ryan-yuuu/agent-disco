...
4. Resolve + validate the model against the live catalog at construction.
   ...
   (:class:`~calfcord.providers.codex.prompts.UnknownCodexModelError`
   / :class:`~calfcord.providers.codex.prompts.DeprecatedCodexModelError`)
...
from calfcord.providers.codex.token_store import load_credentials
