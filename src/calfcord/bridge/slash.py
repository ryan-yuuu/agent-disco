...
* ``/thinking-effort agent:<name> effort:<tier>`` — the operator slash
  ...
  via :mod:`calfcord.agents.md_writer`; the bridge's
...
from calfcord.bridge.normalizer import SlashNormalizer
from calfcord.bridge.registry import AgentRegistry
from calfcord.control_plane.publish import publish_control_command
from calfcord.control_plane.schema import SetThinkingEffortOp
...
class SlashCommandManager:
    ...
    def register_thinking_effort(self) -> None:
        ...
        :mod:`calfcord.agents.thinking` for the full story.
        """
    ...
    def register_clear(self) -> None:
        ...
        (:data:`~calfcord.bridge.history.CLEAR_MARKER_TEXT`)
