...
# top-of-file ``from calfcord.bridge.wire import ...``
...
:func:`~calfcord.agents.phonebook.phonebook_to_deps`) is
...
class MetadataEnvelope(BaseModel):
    ...
    :class:`~calfcord.agents.phonebook.PhonebookEntry`
...
# ``bridge.ingress`` → ``calfcord._compat.invoke`` finds
...
from calfcord.agents.phonebook import (  # noqa: E402
    PhonebookEntry as _PhonebookEntry,
)
from calfcord.bridge.history import (  # noqa: E402
    HistoryRecord as _HistoryRecord,
)
from calfcord.bridge.wire import (  # noqa: E402
