...
bundled :file:`router.md` (see :mod:`calfcord.router.prompt` for
...
to the in-code default in :mod:`calfcord.router.definition`.
"""
...
class RouterConfig(BaseModel):
    ...
    default in :mod:`calfcord.router.definition`.
