...
- [Tansu broker + S3-backed distributed agents](roadmap/tansu-broker.md) — native (no-Docker) Kafka-compatible broker now; shared-S3 multi-host agent communication later. *(Native broker shipped; S3-distributed agents later)*
